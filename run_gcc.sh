...
./build/linux-gcc/bin/Release/blocked_column_multi_output_accumulate --benchmark_min_time=3.0s
./build/linux-gcc/bin/Release/intelmkl --benchmark_min_time=3.0s
